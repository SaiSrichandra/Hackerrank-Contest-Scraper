...
def create_file(uname, cname, submi):
    l = len(submi)
    funame = "test1-py/"+str(uname)
...
url = "https://www.hackerrank.com/rest/contests/test1-py/judge_submissions"
...
if not os.path.exists("test1-py"):
    os.mkdir("test1-py")
...
for id in submission_ids:
    url2 = f'https://www.hackerrank.com/rest/contests/test1-py/submissions/{id}'
...
for key1 in subs:
    for key2 in subs[key1]:
        print(key1,"---",key2)
        create_file(key1, key2, subs[key1][key2])
